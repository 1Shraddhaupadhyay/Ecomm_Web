<x-header title="SingleProducts" description="Hello World" keywords="InfoTech eCommerce"/>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tabs-4" role="tabpanel">
                                <div class="product__details__pic__item">
                                    ...
                                    <a href="https://youtu.be/PoM8Ml6skFc?si=xDJcIGZDQkmo5tUh" class="video-popup"><i class="fa fa-play"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
