            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="addnewp">
                            <a type="button" class="btn btnn text-white" data-toggle="modal"
                                data-target="#addNewModel">
                                Add New
                            </a>
                        </span>
                        <!-- The Modal -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$item->title}}</td>
                                        <td><img src="{{URL::asset('uploads/products/'.$item->picture)}}" width="150px"
                                                alt=""></td>
                                        ...
                                        <td class="font-weight-medium">
                                            <a type="button" class="btn bttn text-white" data-toggle="modal"
                                                data-target="#updateModel{{$i}}">Update</a>
                                            <!-- The Modal -->
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{URL::to('UpdateProduct')}}" method="POST"
                                                                ...
                                                                <input type="text" value="{{$item->description}}" name="description"
                                                                    ...
                                                                    class="form-control mb-2" id="">
                                                                <label for="">Keywords</label>
                                                                <input type="text" value="{{$item->keywords}}" name="keywords"
