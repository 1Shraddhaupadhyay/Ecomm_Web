<x-header title="Cart" description="Hello World" keywords="InfoTech eCommerce"/>
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{URL::asset('uploads/products/'.$item->picture)}}" width="150px" alt="">
                                        </div>
                                    ...
                                    <td class="quantity__item">
                                        <form action="{{URL::to('updateCart')}}" method="POST">
                                            @csrf
                                        <div class="quantity">
                                            <input type="number" class="form-control" min="1" max="{{$item->pQuantity}}" value="{{$item->quantity}}" name="quantity" />
                                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cart__total">
                        ...
                        <!-- <form action="{{URL:: to('stripe')}}"> -->
                            ...
                            <input type="submit" name="checkout" class="primary-btn mt-2 btn-block" value="PLACE ORDER" id="">
                        </form>
                    </div>
                </div>
            </div>
